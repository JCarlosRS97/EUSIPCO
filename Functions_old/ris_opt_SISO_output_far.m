function [ARoutput,AR_K1000_output,AR_anom_output, phase_output] = ris_opt_SISO_output_far(Nris,SNR,K,f,D,dist_ris,lr,lt,Pt) 
% clear; close all;
% Nt = 8;
% Nr = 4;
% Nris = 15^2;
...
[Hdirt,H1t,H2t] = chan_mat_RIS_far_field(Nt,Nr,Nris,lt,lr,D,no_mat,K,f,dist_ris,alpha_dir);

[Hdirt_K1000,H1t_K1000,H2t_K1000] = chan_mat_RIS_far_field(Nt,Nr,Nris,lt,lr,D,1,1000,f,dist_ris,alpha_dir);
