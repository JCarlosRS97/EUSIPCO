...
for indexN = 1:length(Nris_onesize)
    Nris_z = (Nris_onesize( indexN ) );
...
figure(),plot(Nris_onesize*Nris_y, output_optimal), hold on
plot(Nris_onesize*Nris_y, output_focusing)
plot(Nris_onesize*Nris_y, output_miller)
plot(Nris_onesize*Nris_y, output_approx)
xlabel('Number of RIS elements', 'Interpreter','latex','FontSize',10),
