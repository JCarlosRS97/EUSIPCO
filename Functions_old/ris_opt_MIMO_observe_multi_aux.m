function [ARoutput,AR_K1000_output,AR_anom_output, AR_focusing_output, phase_output, ...
    ...
    = ris_opt_MIMO_observe_multi_aux(Nt,Nr,Nris_x,Nris_y,SNR,K,f,D,dist_ris,lr,lt,Pt, no_iter,no_mat) 
% clear; close all;
% Nt = 8;
% Nr = 4;
% Nris = 15^2;
...
offset = 0;
[Hdirt_siso,H1t_siso,H2t_siso] = chan_mat_RIS_new_model_rec_ob(1,1,Nris_x,Nris_y,lt+lambda*offset,lr-lambda*offset,D,1,1000000,f,dist_ris,3);
