function [ARoutput,AR_K1000_output,AR_anom_output, phase_output, ...
    SingleValue_output, LeftSingleVector, RightSingleVector ] = ris_opt_MIMO_output_far(Nt,Nr,Nris,SNR,K,f,D,dist_ris,lr,lt,Pt) 
% clear; close all;
% Nt = 8;
% Nr = 4;
% Nris = 15^2;
...
[Hdirt_K1000,H1t_K1000,H2t_K1000] = chan_mat_RIS_far_field(Nt,Nr,Nris,lt,lr,D,1,100000,f,dist_ris,alpha_dir);
