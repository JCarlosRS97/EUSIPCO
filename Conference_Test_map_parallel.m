...
parfor indexN = 1:length(X_vec)
    ...
    [rate_ND_NUM_WA, rate_ND_PSWF_WA, rate_FOC_NUM_WA, rate_FOC_PSWF_WA,...
        ...
        ris_opt_MIMO_UPA_parallel(Nt_y,Nt_z,Nr_y,Nr_z,Nris_x,Nris_y,Pt,P_noise,f,r0_TX, r0_RX,r0_RIS);
...
filename = [ 'Results\Map_RIS_MIMO_Nty' num2str(Nt_y) 'Ntz' num2str(Nt_z) 'Nry' num2str(Nr_y) 'Nrz' num2str(Nr_z)...
    'Nrisx' num2str(Nris_x)  '_parallel.mat'];
save( filename )
%%
close all
...
[f_ND_num,x_ND_num] = ccdf(output_ND_num_WA);
[f_ND_PSWF,x_ND_PSWF] = ccdf(output_ND_PSWF_WA);
[f_FOC_num,x_FOC_num] = ccdf(output_FOC_num_WA);
[f_FOC_PSWF,x_FOC_PSWF] = ccdf(output_FOC_PSWF_WA);
